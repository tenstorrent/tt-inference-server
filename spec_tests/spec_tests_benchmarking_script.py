...
async def main():
    ...
    parser.add_argument("--backend", type=str, default="vllm", help="Backend type (vllm)")
    parser.add_argument("--model", type=str, required=True, help="Model name")
    parser.add_argument("--port", type=int, default=8000, help="Server port")
    parser.add_argument("--host", type=str, default="127.0.0.1", help="Server host")
    parser.add_argument("--dataset-name", type=str, default="cleaned-random", 
    ...
    parser.add_argument("--result-filename", type=str, 
                       help="Filename to save benchmark results")
