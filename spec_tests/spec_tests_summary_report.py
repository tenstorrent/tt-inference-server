...
def format_metrics(metrics):
    ...
    sig_digits_map = {
        ...
        "p95_e2el_ms": 1,
        "p99_e2el_ms": 1,
        "mean_wall_clock_e2el_ms": 1,
        "p5_wall_clock_e2el_ms": 1,
        "p25_wall_clock_e2el_ms": 1,
        "p50_wall_clock_e2el_ms": 1,
        "p95_wall_clock_e2el_ms": 1,
        "p99_wall_clock_e2el_ms": 1,
    }
...
def process_benchmark_file(filepath: str) -> Dict[str, Any]:
    ...
    metrics = {
        ...
        "mean_wall_clock_e2el_ms": data.get("mean_wall_clock_e2el_ms"),
        "p5_wall_clock_e2el_ms": data.get("p5_wall_clock_e2el_ms"),
        "p25_wall_clock_e2el_ms": data.get("p25_wall_clock_e2el_ms"),
        "p50_wall_clock_e2el_ms": data.get("p50_wall_clock_e2el_ms"),
        "p95_wall_clock_e2el_ms": data.get("p95_wall_clock_e2el_ms"),
        "p99_wall_clock_e2el_ms": data.get("p99_wall_clock_e2el_ms"),
        "wall_clock_total_throughput": data.get("wall_clock_total_throughput"),
