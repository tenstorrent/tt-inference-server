...
def setup_evals_common(
    ...
    return_code = run_command(
        ...
        "git+https://github.com/tstescoTT/lm-evaluation-harness.git@adam/incremental-logging#egg=lm-eval[api,ifeval,math,sentencepiece,r1_evals,ruler,longbench,hf] "
