...
def main():
    ...
    # Stress tests generate their own report in-process via report_module
    # (tt-inference-server-v2/test_module/stress_tests/run_stress_tests.py), so
    # they are no longer aggregated here.
