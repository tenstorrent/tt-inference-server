...
yolov7_tt_server_impl = ImplSpec(
    impl_id="yolov7_tt_server",
    impl_name="yolov7-tt-server",
    repo_url="https://github.com/tenstorrent/tt-metal",
    code_path="models/demos/yolov7",
)
tt_server_impl_ids = {"cnn_tt_server", "yolov7_tt_server", "sdxl_tt_server"}
...
spec_templates = [
    ...
    ModelSpecTemplate(
        weights=["yolov7"],  # Custom identifier for YOLOv7 model
        tt_metal_commit="v0.62.2",
        impl=yolov7_tt_server_impl,
        min_disk_gb=5,
        min_ram_gb=2,
        ...
        docker_cmd=["/bin/bash", "-c", "source ${PYTHON_ENV_DIR}/bin/activate && cd ${TT_METAL_HOME}/server/ && python3 /home/container_app_user/docker_run_scripts/model_scripts/yolov7_ci_script.py"],
        device_model_specs=[
            DeviceModelSpec(
                device=DeviceTypes.N150,
                max_concurrency=8,
