...
def _engine_dependency_venv_types(
    ...
    # Embedding benchmarks shell out to `vllm bench serve` from the engine-selected
    # vllm client venv, which nothing else provisions for a media/forge model —
    # without this the benchmark child dies on a missing bin/vllm.
    if (
