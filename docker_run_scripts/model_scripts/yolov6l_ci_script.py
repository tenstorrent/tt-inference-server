...
class DirectInferenceImageClient:
    """Mock ImageClient that runs YOLOv6L inference directly instead of HTTP calls."""
    ...
    def search_image(self, image_data: str):
        """Mock image search that simulates YOLOv6L inference."""
...
def main():
    """Main function to run the YOLOv6L CI script."""
    logger.info("Starting YOLOv6L CI script...")
