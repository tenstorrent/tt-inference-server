...
def main() -> int:
    ...
    # SPEC_DECODE declares only a requirements_file (no setup_function), so its
    # setup does not depend on a model_spec.
    from workflows.workflow_types import WorkflowVenvType

    return setup_venv_and_exec(WorkflowVenvType.SPEC_DECODE, logger, "spec decode")
