...
class Qwen3TTSServer:
    def __init__(self, device_id=0, ref_audio=None, ref_text=None, use_2cq=True, max_new_tokens=256, temperature=None):
        print("=" * 60)
        ...
        if temperature is not None:
            ...
            print(f"  Temperature override: {temperature}")
    ...
    def synthesize(self, text: str, output_path: str, language: str = "english") -> dict:
        ...
        try:
            ...
            # Run inference (returns codec codes, no streaming decoder in new API)
            ...
            audio = self.decode_audio(codes, self.decoder_weights)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--temperature", type=float, default=None, help="Sampling temperature (default: model config)")
