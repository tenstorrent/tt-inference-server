...
def register_tt_models(register_test_models=False) -> None:
    ...
    # OLMo-3.1-32B - Text
    # Note: vLLM internally maps Olmo3ForCausalLM -> Olmo2ForCausalLM (registry.py line 148)
    # so the resolved arch name becomes TTOlmo2ForCausalLM. We register under that name.
    ...
    if olmo3_text_version == "olmo3_32b_galaxy":
        ...
        raise ValueError(
            f"Unsupported TT OLMo3 version: {olmo3_text_version}, "
            "pick one of [olmo3_32b_galaxy]"
        )
