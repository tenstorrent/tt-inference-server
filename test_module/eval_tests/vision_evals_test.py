...
DATASET_DIR = "test_fixtures/datasets/imagenet_subset"
MODELS = [
    "tt-xla-resnet",
    "tt-xla-vovnet",
    "tt-xla-mobilenetv2",
...
Example commands:
    python test_module/eval_tests/vision_evals_test.py --download 20
    python test_module/eval_tests/vision_evals_test.py --measure_cpu_accuracy
    python test_module/eval_tests/vision_evals_test.py --measure_cpu_accuracy --model tt-xla-resnet
    python test_module/eval_tests/vision_evals_test.py --measure_device_accuracy
    python test_module/eval_tests/vision_evals_test.py --measure_device_accuracy --model tt-xla-resnet --server_url http://127.0.0.1:8000/v1/cnn/search-image
    python test_module/eval_tests/vision_evals_test.py --compare_results
"""
