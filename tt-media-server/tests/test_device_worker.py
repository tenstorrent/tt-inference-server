...
class TestDeviceWorker:
    ...
    def test_device_worker_initialization_failure(self, mock_queues):
        ...
        error_queue.put.assert_called_once_with(
            ("worker_0", "Device initialization failed")
        )
    ...
    def test_device_worker_inference_error(
        ...
        error_queue.put.assert_any_call(
            ("task_1", "Worker worker_0 inference error: Inference failed")
        )
        error_queue.put.assert_any_call(
            ("task_2", "Worker worker_0 inference error: Inference failed")
        )
