...
runner_mocks = {
    'tt_model_runners.base_device_runner': {'BaseDeviceRunner': type('BaseDeviceRunner', (), {})},  # Base class mock
    'tt_model_runners.sdxl_generate_runner_trace': {'TTSDXLGenerateRunnerTrace': create_mock_runner_class('TTSDXLGenerateRunnerTrace')},
    'tt_model_runners.sdxl_image_to_image_runner_trace': {'TTSDXLImageToImageRunner': create_mock_runner_class('TTSDXLImageToImageRunner')},
    'tt_model_runners.sdxl_edit_runner_trace': {'TTSDXLEditRunner': create_mock_runner_class('TTSDXLEditRunner')},
    'tt_model_runners.dit_runners': {
        ...
        'TTMotifImage6BPreviewRunner': create_mock_runner_class('TTMotifImage6BPreviewRunner'),
        'TTMochi1Runner': create_mock_runner_class('TTMochi1Runner'),
        'TTWan22Runner': create_mock_runner_class('TTWan22Runner'),
    },
    'tt_model_runners.whisper_runner': {'TTWhisperRunner': create_mock_runner_class('TTWhisperRunner')},
    'tt_model_runners.vllm_forge_runner': {'VLLMForgeRunner': create_mock_runner_class('VLLMForgeRunner')},
    'tt_model_runners.test_runner': {'TestRunner': create_mock_runner_class('TestRunner')},
    'tt_model_runners.vllm_forge_qwen_embedding_runner': {'VLLMForgeEmbeddingQwenRunner': create_mock_runner_class('VLLMForgeEmbeddingQwenRunner')},
    'tt_model_runners.mock_runner': {'MockRunner': create_mock_runner_class('MockRunner')},
    ...
    'tt_model_runners.forge_runners.forge_runner': {'ForgeRunner': create_mock_runner_class('ForgeRunner')},
}
...
forge_runners_module.ForgeMobilenetv2Runner = create_mock_runner_class('ForgeMobilenetv2Runner')
forge_runners_module.ForgeEfficientnetRunner = create_mock_runner_class('ForgeEfficientnetRunner')
forge_runners_module.ForgeSegformerRunner = create_mock_runner_class('ForgeSegformerRunner')
