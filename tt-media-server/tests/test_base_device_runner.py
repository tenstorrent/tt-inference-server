...
class TestBaseDeviceRunner(unittest.TestCase):
    ...
    def test_initialization_success(self, mock_get_settings, mock_setup_env):
        ...
        runner = ConcreteDeviceRunner(self.device_id)
        ...
        # Verify setup_runner_environment was called
        mock_setup_env.assert_called_once()

    @patch("tt_model_runners.base_device_runner.setup_runner_environment")
    @patch("tt_model_runners.base_device_runner.get_settings")
    def test_tensor_parallel_mode_enabled(self, mock_get_settings, mock_setup_env):
    ...
    @patch("tt_model_runners.base_device_runner.setup_runner_environment")
    @patch("tt_model_runners.base_device_runner.get_settings")
    def test_tensor_parallel_mode_disabled(self, mock_get_settings, mock_setup_env):
    ...
    @patch("tt_model_runners.base_device_runner.setup_runner_environment")
    @patch("tt_model_runners.base_device_runner.get_settings")
    def test_logger_initialization(self, mock_get_settings, mock_setup_env):
    ...
    @patch("tt_model_runners.base_device_runner.setup_runner_environment")
    @patch("tt_model_runners.base_device_runner.get_settings")
    def test_set_device_default_implementation(self, mock_get_settings, mock_setup_env):
    ...
    @patch("tt_model_runners.base_device_runner.setup_runner_environment")
    @patch("tt_model_runners.base_device_runner.get_settings")
    def test_is_request_batchable_with_batch(self, mock_get_settings, mock_setup_env):
    ...
    @patch("tt_model_runners.base_device_runner.setup_runner_environment")
    @patch("tt_model_runners.base_device_runner.get_settings")
    def test_device_id_stored_correctly(self, mock_get_settings, mock_setup_env):
        ...
        for device_id in test_device_ids:
            runner = ConcreteDeviceRunner(device_id)
