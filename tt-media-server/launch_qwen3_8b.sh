...
# Qwen3-8B on a single chip. Pinned to chip 3 / port 8004 so it can run alongside
# the other single-chip forge LLM servers (see launch_falcon3_7b.sh,
# launch_llama_8b.sh, launch_llama_3b.sh).
