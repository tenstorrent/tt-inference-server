...
AVAILABLE_RUNNERS = {
    ...
    ModelRunners.DUMMY: lambda wid: __import__("tt_model_runners.dumy-streaming_runner", fromlist=["DummyStreamingRunner"]).DummyStreamingRunner(wid),
    ModelRunners.TT_SDXL_EDIT: lambda wid: __import__("tt_model_runners.sdxl_edit_runner_trace", fromlist=["TTSDXLEditRunner"]).TTSDXLEditRunner(wid),
    ...
    ModelRunners.TT_WHISPER: lambda wid: __import__("tt_model_runners.dumy-streaming_runner", fromlist=["DummyStreamingRunner"]).DummyStreamingRunner(wid),
