...
# Llama-3.2-3B-Instruct on a single chip. Pinned to chip 2 / port 8003 so it can
# run alongside the other single-chip forge LLM servers (see launch_falcon3_7b.sh,
# launch_llama_8b.sh, launch_qwen3_8b.sh).
...
export TT_VISIBLE_DEVICES=${TT_VISIBLE_DEVICES:-2}
