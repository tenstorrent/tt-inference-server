...
class TextToSpeechRequest(BaseRequest):
    ...
    speaker_embedding: Optional[Union[str, bytes]] = None  # Base64-encoded or raw bytes of speaker embedding
    ...
    _speaker_embedding_array: Optional[np.ndarray] = None  # Processed speaker embedding as numpy array
