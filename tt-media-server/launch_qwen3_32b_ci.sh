...
#
# Qwen3-32B TP (4-chip, (1,4) mesh) forge LLM launcher that mirrors the
# CI / production config (workflows/model_specs/dev/cnn.yaml, Qwen3-32B FORGE
# spec on P300X2): b32, native 40960 context, chunk 1024, gmu 0.35, bfp8
...
# P300 opt>=1 fix already; see vllm_forge_qwen_32b.py for details):
#   cd /home/kmabee/tt-xla-2 && source venv/activate && \
#   cd /home/kmabee/tt-inference-server/tt-media-server && ./launch_qwen3_32b_ci.sh
...
# --- Qwen3-32B FORGE spec, verbatim from cnn.yaml ---
