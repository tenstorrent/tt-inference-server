...
"""Verify cache-aware prefill routing for Gateway and Dynamo stacks.
...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--mode", choices=("gateway", "dynamo"), required=True)
...
def read_from_offsets(logs: Iterable[Path], offsets: dict[Path, int]) -> list[tuple[Path, str]]:
