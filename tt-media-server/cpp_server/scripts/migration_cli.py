...
def _add_produce_args(p: argparse.ArgumentParser) -> None:
    ...
    p.add_argument("--layer-begin", type=int, default=0)
    p.add_argument("--layer-end", type=int, default=1)
    p.add_argument("--src-pos-begin", type=int, default=0)
    p.add_argument("--src-pos-end", type=int, default=16)
    p.add_argument("--dst-pos-begin", type=int, default=0)
    p.add_argument("--dst-pos-end", type=int, default=16)
