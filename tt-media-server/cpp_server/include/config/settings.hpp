...
/** Memory request queue name from TT_MEMORY_REQUEST_QUEUE. Default: defaults::TT_MEMORY_REQUEST_QUEUE. */
std::string ttMemoryRequestQueueName();

/** Warmup signals queue name from TT_WARMUP_SIGNALS_QUEUE. Default: defaults::TT_WARMUP_SIGNALS_QUEUE. */
std::string ttWarmupSignalsQueueName();

/** Memory result queue name from TT_MEMORY_RESULT_QUEUE. Default: defaults::TT_MEMORY_RESULT_QUEUE. */
