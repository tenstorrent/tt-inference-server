...
constexpr const char* MIGRATION_CMD_QUEUE_NAME = "ep0_cmd";
constexpr const char* MIGRATION_TABLE_QUEUE_NAME = "ep0_table";
constexpr const char* MIGRATION_RESP_QUEUE_NAME = "ep0_resp";
