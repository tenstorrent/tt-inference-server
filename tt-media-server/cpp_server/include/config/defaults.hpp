...
constexpr const char* MIGRATION_CMD_QUEUE_NAME = "tt_migration_cmd";
constexpr const char* MIGRATION_TABLE_QUEUE_NAME = "tt_migration_table";
constexpr const char* MIGRATION_RESP_QUEUE_NAME = "tt_migration_resp";
