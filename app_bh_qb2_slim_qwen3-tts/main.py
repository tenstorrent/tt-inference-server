...
# TTS backend: "speecht5" (SpeechT5 TTNN socket) or "lv2" (Lightning V2 HTTP)
TTS_BACKEND = os.environ.get("TTS_BACKEND", "speecht5")
if TTS_BACKEND == "lv2":
                ...
                while True:
                    ...
                    try:
                        ...
                        tts_result = await asyncio.wait_for(
                            tts_service.synthesize(s_text, speaker_id=speaker_val),
                            timeout=60.0
                        )
