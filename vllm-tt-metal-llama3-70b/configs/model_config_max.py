...
def get_model_config(
    llama_version="llama3", max_batch_size=32, max_context_len=4096, vllm=False
):
    ...
    shard_width_hidden_dim_per_device_across_32_cores = (
        shard_width_hidden_dim_across_32_cores // num_devices
    )
    shard_width_hidden_dim_per_device_across_16_cores = (
        shard_width_hidden_dim_across_16_cores // num_devices
    )
    ...
    )  # 8 q_heads + 1 k_heads + 1 v_heads
    n_local_kv_heads = n_kv_heads // num_devices
    total_width_of_qkv_heads_per_device = (
        total_width_per_group_of_qkv_heads * n_local_kv_heads
    )
    shard_width_qkv_heads_per_device_across_8_cores = (
        total_width_of_qkv_heads_per_device // 8
    )
    ...
    # LM Head
    model_config["LM_HEAD_MM_PROGCFG"] = (
    ...
    model_config["LLAMA3_LM_HEAD_MM_PROGCFG"] = (
        ttnn.MatmulMultiCoreReuseMultiCast1DProgramConfig(
            compute_with_storage_grid_size=(8, 4),
            in0_block_w=8,
            out_subblock_h=1,
    ...
    model_config["PREFILL_LM_HEAD_MM_PROGCFG"] = (
        ttnn.MatmulMultiCoreReuseMultiCastProgramConfig(
            compute_with_storage_grid_size=(8, 8),
            in0_block_w=1,  # how much inner dim you take each time
            out_subblock_h=1,  # Must be divisible by per_core_M
            out_subblock_w=1,  # Must be divisible by per_core_N, out_subblock_w * out_subblock_h <= 4
            per_core_M=max_mm_seq_tiles
            // 8,  # M / TILE_HEIGHT / Grid_Size (dynamic based on seqlen)
    ...
    model_config["PREFILL_LM_HEAD_MM_PROGCFG_128"] = (
        ttnn.MatmulMultiCoreReuseMultiCastProgramConfig(
            compute_with_storage_grid_size=(8, 4),
            in0_block_w=1,  # how much inner dim you take each time
            out_subblock_h=1,  # Must be divisible by per_core_M
    ...
    max_mm_seq_tiles = model_config["MAX_MM_SEQ_LEN"] // 32
    model_config["PREFILL_LLAMA3_LM_HEAD_MM_PROGCFG"] = (
        ttnn.MatmulMultiCoreReuseMultiCastProgramConfig(
            compute_with_storage_grid_size=(8, 8),
            in0_block_w=1,  # how much inner dim you take each time
            out_subblock_h=1,  # Must be divisible by per_core_M
    ...
    model_config["PREFILL_LLAMA3_LM_HEAD_MM_PROGCFG_128"] = (
        ttnn.MatmulMultiCoreReuseMultiCastProgramConfig(
            compute_with_storage_grid_size=(8, 4),
            in0_block_w=1,  # how much inner dim you take each time
            out_subblock_h=1,  # Must be divisible by per_core_M
    ...
    model_config["PREFILL_FUSED_QKV_MM_PROGCFG"] = (
        ttnn.MatmulMultiCoreReuseMultiCastProgramConfig(
            compute_with_storage_grid_size=(8, 8),
    ...
    in0_block_w = 32
    model_config["PREFILL_FUSED_QKV_MM_PROGCFG_128"] = (
        ttnn.MatmulMultiCoreReuseMultiCastProgramConfig(
            compute_with_storage_grid_size=(8, 4),
            in0_block_w=in0_block_w,  # how much inner dim you take each time
            out_subblock_h=1,  # Must be divisible by per_core_M
    ...
    model_config["FUSED_QKV_MM_PROGCFG"] = (
        ttnn.MatmulMultiCoreReuseMultiCast1DProgramConfig(
    ...
    model_config["SDPA_OUTPUT_MEMCFG"] = ttnn.MemoryConfig(
        ...
        ttnn.BufferType.L1,
        ttnn.ShardSpec(
            batch_core_range, (32, head_dim), ttnn.ShardOrientation.ROW_MAJOR, False
        ),  # padded local heads
    )
    ...
    max_mm_seq_tiles = model_config["MAX_MM_SEQ_LEN"] // 32
    in0_block_w = 8  # smaller in0_block_w for larger seq_len to fit in L1)
    model_config["PREFILL_SELFOUT_MM_PROGCFG"] = (
        ttnn.MatmulMultiCoreReuseMultiCastProgramConfig(
            compute_with_storage_grid_size=(8, 8),
    ...
    model_config["PREFILL_SELFOUT_MM_PROGCFG_128"] = (
        ttnn.MatmulMultiCoreReuseMultiCastProgramConfig(
            compute_with_storage_grid_size=(8, 4),
            in0_block_w=8,  # how much inner dim you take each time
            out_subblock_h=1,  # Must be divisible by per_core_M
    ...
    model_config["PADDED_FF3_MM_PROGCFG"] = (
    ...
    model_config["PADDED_FF2_MM_PROGCFG"] = (
        ttnn.MatmulMultiCoreReuseMultiCastDRAMShardedProgramConfig(
    ...
    max_mm_seq_tiles = model_config["MAX_MM_SEQ_LEN"] // 32
    model_config["PREFILL_PADDED_FF1_MM_PROGCFG"] = (
        ttnn.MatmulMultiCoreReuseMultiCastProgramConfig(
            compute_with_storage_grid_size=(8, 8),
    ...
    model_config["PREFILL_PADDED_FF1_MM_PROGCFG_128"] = (
        ttnn.MatmulMultiCoreReuseMultiCastProgramConfig(
            compute_with_storage_grid_size=(8, 4),
            in0_block_w=4,  # how much inner dim you take each time
            out_subblock_h=1,  # Must be divisible by per_core_M
    ...
    model_config["PREFILL_PADDED_FF3_MM_PROGCFG"] = (
        ttnn.MatmulMultiCoreReuseMultiCastProgramConfig(
            compute_with_storage_grid_size=(8, 8),
            in0_block_w=4,  # how much inner dim you take each time
            out_subblock_h=1,  # Must be divisible by per_core_M
    ...
    model_config["PREFILL_PADDED_FF3_MM_PROGCFG_128"] = (
        ttnn.MatmulMultiCoreReuseMultiCastProgramConfig(
            compute_with_storage_grid_size=(8, 4),
            in0_block_w=4,  # how much inner dim you take each time
            out_subblock_h=1,  # Must be divisible by per_core_M
    ...
    # input0: [1,32,128,32k]
    # input1: [1,1,32k,1k]
    model_config["PREFILL_PADDED_FF2_MM_PROGCFG"] = (
        ttnn.MatmulMultiCoreReuseMultiCastProgramConfig(
            compute_with_storage_grid_size=(8, 8),
            in0_block_w=4,  # how much inner dim you take each time
            out_subblock_h=1,  # Must be divisible by per_core_M
    ...
    model_config["PREFILL_PADDED_FF2_MM_PROGCFG_128"] = (
        ttnn.MatmulMultiCoreReuseMultiCastProgramConfig(
            compute_with_storage_grid_size=(8, 4),
            in0_block_w=4,  # how much inner dim you take each time
            out_subblock_h=1,  # Must be divisible by per_core_M
