...
# The scoped Qwen3.8 release check intentionally contains only its declared
# 128/128 performance reference, not the generic characterization sweep.
_PERF_REFERENCE_ONLY_IMPLS = frozenset({"qwen38-autoport-b1"})
