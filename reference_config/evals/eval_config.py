        ...
        tasks=[
            ...
            EvalTask(
                ...
                agentic_eval_config=TerminalBenchEvalConfig(
                    dataset="terminal-bench/terminal-bench-2",
                    agent="terminus-2",
                    n_concurrent_trials=8,  # 16 -> 8: SC20 speculative-decode deployment (8 concurrent users), 2026-09-15
                    n_attempts=1,
                        ...
                        "config": {
                            "model": {
                                "model_kwargs": {
                                    "temperature": 1.0,
                                    "top_p": 0.95,
                                    # Branch's completion_kwargs.extra_body
                                    # carried into the Harbor model_kwargs path.
                                    # mini-swe-agent merges this into LiteLLM
                                    # model_kwargs; same remote-host thinking gap
                                    # as terminal_bench_2's llm_call_kwargs.
                                    "extra_body": {
                                        "top_k": 20,
                                        "chat_template_kwargs": {
                                            "enable_thinking": True,
