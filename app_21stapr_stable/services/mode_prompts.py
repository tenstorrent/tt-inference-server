...
MODES = {
    "talk": {
        ...
        "system_prompt": (
            ...
            "your thought and never stop mid-sentence. Remember the context of our conversation. "
            "NEVER use markdown, bullet points, asterisks, numbered lists, or any formatting. "
            "Write in plain flowing sentences as if you are speaking out loud."
        ),
        "max_tokens": 200,
    ...
    "docs": {
        ...
        "system_prompt": (
            ...
            "Be concise -- your response will be read aloud. "
            "NEVER use markdown, bullet points, asterisks, numbered lists, or any formatting. "
            "Write in plain flowing sentences as if you are speaking out loud. "
