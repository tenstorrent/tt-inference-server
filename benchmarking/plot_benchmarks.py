...
def plot_phase2_osl(records, fixed_isl: int, output_dir: Path):
    """Impact of increasing OSL on TTFT and TPOT (concurrency=1)."""
    data = filter_records(records, _isl=fixed_isl, _conc=1)
    if not data:
...
def main():
    ...
    plot_phase1_isl(records, args.phase1_osl, output_dir)

    print("Phase 2: OSL impact ...")
    plot_phase2_osl(records, args.phase2_isl, output_dir)
