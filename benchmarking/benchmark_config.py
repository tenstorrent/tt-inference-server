            ...
            param_map={
                ...
                + [
                    BenchmarkTaskParams(
                        ...
                        osl=osl,
                        max_concurrency=2,
                        num_prompts=get_num_prompts(isl, osl, 2),
                    )
                    for isl, osl in BATCH_1_BENCHMARK_COMMON_ISL_OSL_PAIRS
                    if (isl, osl, 2)
                ...
                + [
                    BenchmarkTaskParams(
                        ...
                        osl=osl,
                        max_concurrency=4,
                        num_prompts=get_num_prompts(isl, osl, 4),
                    )
                    for isl, osl in BATCH_1_BENCHMARK_COMMON_ISL_OSL_PAIRS
                    if (isl, osl, 4)
                    not in perf_ref_task_runs.get(_device, [])
                ...
                + [
                    BenchmarkTaskParams(
                        ...
                        osl=osl,
                        max_concurrency=8,
                        num_prompts=get_num_prompts(isl, osl, 8),
                    )
                    for isl, osl in BATCH_1_BENCHMARK_COMMON_ISL_OSL_PAIRS
                    if (isl, osl, 8)
                    not in perf_ref_task_runs.get(_device, [])
                ...
                + [
                    BenchmarkTaskParams(
                        ...
                        osl=osl,
                        max_concurrency=16,
                        num_prompts=get_num_prompts(isl, osl, 16),
                    )
                    for isl, osl in BATCH_1_BENCHMARK_COMMON_ISL_OSL_PAIRS
                    if (isl, osl, 16)
                    not in perf_ref_task_runs.get(_device, [])
                ...
                + [
                    BenchmarkTaskParams(
                        ...
                        osl=osl,
                        max_concurrency=32,
                        num_prompts=get_num_prompts(isl, osl, 32),
                    )
                    for isl, osl in BATCH_1_BENCHMARK_COMMON_ISL_OSL_PAIRS
                    if (isl, osl, 32)
                    not in perf_ref_task_runs.get(_device, [])
