...
#
# Vendored from vLLM v0.13.0 (commit 9f771b3ab) at
# benchmarks/benchmark_serving_structured_output.py. Pinned to match the
# vllm==0.13.0 wheel installed in the BENCHMARKS_VLLM workflow venv.
