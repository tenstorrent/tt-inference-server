# bge-m3 Tenstorrent Support on N150/N300
...
## Quickstart - Deploy bge-m3 Inference Server on n150
...
```bash
python3 run.py --model bge-m3 --device n150 --workflow server --docker-server
```
