# bge-m3 Tenstorrent Support on WH Galaxy
...
- [WH LoudBox/QuietBox](bge-m3_t3k.md)
- [N150/N300](bge-m3_n150.md)

## Quickstart - Deploy bge-m3 Inference Server on WH Galaxy
...
```bash
python3 run.py --model bge-m3 --device galaxy --workflow server --docker-server
```
