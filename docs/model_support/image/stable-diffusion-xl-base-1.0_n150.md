# stable-diffusion-xl-base-1.0 Tenstorrent Support on N150
...
```bash
python3 run.py --model stabilityai/stable-diffusion-xl-base-1.0 --device n150 --workflow server --docker-server
```
