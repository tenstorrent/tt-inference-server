# stable-diffusion-xl-base-1.0 Tenstorrent Support on P100/P150
...
## Quickstart - Deploy stable-diffusion-xl-base-1.0 Inference Server on p150
...
```bash
python3 run.py --model stable-diffusion-xl-base-1.0 --device p150 --workflow server --docker-server
```
