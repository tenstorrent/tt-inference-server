# stable-diffusion-xl-1.0-inpainting-0.1 Tenstorrent Support on P100/P150
...
## Quickstart - Deploy stable-diffusion-xl-1.0-inpainting-0.1 Inference Server on p150
...
```bash
python3 run.py --model stable-diffusion-xl-1.0-inpainting-0.1 --device p150 --workflow server --docker-server
```
