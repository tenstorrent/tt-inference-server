# stable-diffusion-xl-base-1.0 Tenstorrent Support on BH LoudBox
...
## Quickstart - Deploy stable-diffusion-xl-base-1.0 Inference Server on BH LoudBox
...
```bash
python3 run.py --model stable-diffusion-xl-base-1.0 --device p150x8 --workflow server --docker-server
```
