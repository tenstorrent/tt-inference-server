# FLUX.1-dev Tenstorrent Support on BH P300
...
## Quickstart - Deploy FLUX.1-dev Inference Server on BH P300
...
```bash
python3 run.py --model black-forest-labs/FLUX.1-dev --device p300 --workflow server --docker-server
```
