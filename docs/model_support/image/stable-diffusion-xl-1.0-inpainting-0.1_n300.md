# stable-diffusion-xl-1.0-inpainting-0.1 Tenstorrent Support on N300
...
## Quickstart - Deploy stable-diffusion-xl-1.0-inpainting-0.1 Inference Server on n300
...
```bash
python3 run.py --model diffusers/stable-diffusion-xl-1.0-inpainting-0.1 --device n300 --workflow server --docker-server
```
