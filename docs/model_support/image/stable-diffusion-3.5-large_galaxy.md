...
```bash
python3 run.py --model stabilityai/stable-diffusion-3.5-large --device galaxy --workflow server --docker-server
```
...
| Docker Image | `ghcr.io/tenstorrent/tt-media-inference-server:0.4.0-13f44c5` |
