# Qwen2.5-VL-7B-Instruct Tenstorrent Support on TT-LoudBox

Qwen2.5-VL-7B-Instruct is also supported on:

- [n150](Qwen2.5-VL-7B-Instruct_n150.md)
- [n300](Qwen2.5-VL-7B-Instruct_n300.md)
...
## Quickstart - Deploy Qwen2.5-VL-7B-Instruct Inference Server on TT-LoudBox
