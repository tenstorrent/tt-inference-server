# Qwen2.5-VL-7B-Instruct Tenstorrent Support on WH LoudBox/QuietBox
...
- [N150/N300](Qwen2.5-VL-7B-Instruct_n150.md)

## Quickstart - Deploy Qwen2.5-VL-7B-Instruct Inference Server on WH LoudBox/QuietBox
