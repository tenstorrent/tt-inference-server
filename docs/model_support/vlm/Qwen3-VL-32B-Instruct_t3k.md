# Qwen3-VL-32B-Instruct Tenstorrent Support on WH LoudBox/QuietBox
...
## Quickstart - Deploy Qwen3-VL-32B-Instruct Inference Server on WH LoudBox/QuietBox
...
docker run \
  ...
  ghcr.io/tenstorrent/tt-inference-server/vllm-tt-metal-src-release-ubuntu-22.04-amd64:0.11.0-ba32283-4386a82 \
...
```bash
python3 run.py --model Qwen3-VL-32B-Instruct --device t3k --workflow server --docker-server
```
...
| vLLM Commit | `4386a82` |
| Docker Image | `ghcr.io/tenstorrent/tt-inference-server/vllm-tt-metal-src-release-ubuntu-22.04-amd64:0.11.0-ba32283-4386a82` |
