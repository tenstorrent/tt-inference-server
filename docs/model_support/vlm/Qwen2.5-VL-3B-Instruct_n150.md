# Qwen2.5-VL-3B-Instruct Tenstorrent Support on N150/N300
...
## Quickstart - Deploy Qwen2.5-VL-3B-Instruct Inference Server on n150
...
docker run \
  ...
  --volume volume_id_Qwen2.5-VL-3B-Instruct:/home/container_app_user/cache_root \
