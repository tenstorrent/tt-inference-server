# Qwen2.5-VL-3B-Instruct Tenstorrent Support on N300
...
## Quickstart - Deploy Qwen2.5-VL-3B-Instruct Inference Server on n300
...
```bash
python3 run.py --model Qwen/Qwen2.5-VL-3B-Instruct --device n300 --workflow server --docker-server
```
