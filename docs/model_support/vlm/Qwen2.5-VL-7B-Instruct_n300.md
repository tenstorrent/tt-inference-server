# Qwen2.5-VL-7B-Instruct Tenstorrent Support on n300

Qwen2.5-VL-7B-Instruct is also supported on:

- [n150](Qwen2.5-VL-7B-Instruct_n150.md)
- [TT-LoudBox](Qwen2.5-VL-7B-Instruct_t3k.md)
...
## Quickstart - Deploy Qwen2.5-VL-7B-Instruct Inference Server on n300
