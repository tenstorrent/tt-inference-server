...
To use non-default weights, replace `meta-llama/Llama-3.2-90B-Vision` in commands below.
...
```bash
python3 run.py --model meta-llama/Llama-3.2-90B-Vision --device t3k --workflow server --docker-server
```
