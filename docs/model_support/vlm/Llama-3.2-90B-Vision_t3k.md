# Llama-3.2-90B-Vision Tenstorrent Support on TT-LoudBox
...
## Quickstart - Deploy Llama-3.2-90B-Vision Inference Server on TT-LoudBox
...
The default model weights for this implementation is `Llama-3.2-90B-Vision`, the following weights are supported as well:
