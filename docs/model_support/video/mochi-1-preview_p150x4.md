# mochi-1-preview Tenstorrent Support on BH 4xP150
...
## Quickstart - Deploy mochi-1-preview Inference Server on BH 4xP150
...
```bash
python3 run.py --model mochi-1-preview --device p150x4 --workflow server --docker-server
```
...
| Docker Image | `ghcr.io/tenstorrent/tt-media-inference-server:0.11.0-555f240` |
