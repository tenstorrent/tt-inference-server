# gpt-oss-20b Tenstorrent Support on Tenstorrent Galaxy (GALAXY_T3K)

gpt-oss-20b is also supported on:

- [TT-LoudBox](gpt-oss-20b_t3k.md)
...
## Quickstart - Deploy gpt-oss-20b Inference Server on Tenstorrent Galaxy
