...
docker run \
  ...
  ghcr.io/tenstorrent/tt-inference-server/vllm-tt-metal-src-release-ubuntu-22.04-amd64:0.11.0-0900acd-22be241 \
...
| Implementation Code | [deepseek-r1-galaxy](https://github.com/tenstorrent/tt-metal/tree/0900acd/models/demos/deepseek_v3) |
| tt-metal Commit | `0900acd` |
| vLLM Commit | `22be241` |
| Docker Image | `ghcr.io/tenstorrent/tt-inference-server/vllm-tt-metal-src-release-ubuntu-22.04-amd64:0.11.0-0900acd-22be241` |
