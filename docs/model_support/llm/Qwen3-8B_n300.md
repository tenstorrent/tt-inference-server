# Qwen3-8B Tenstorrent Support on N300
...
## Quickstart - Deploy Qwen3-8B Inference Server on n300
...
```bash
python3 run.py --model Qwen/Qwen3-8B --device n300 --workflow server --docker-server
```
