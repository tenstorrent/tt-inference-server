...
docker run \
  ...
  ghcr.io/tenstorrent/tt-inference-server/vllm-tt-metal-src-release-ubuntu-22.04-amd64:0.21.0-de59f8a-c127c17 \
  --model Qwen3-32B \
...
| Implementation Code | [qwen3-32b-galaxy](https://github.com/tenstorrent/tt-metal/tree/de59f8a/models/demos/llama3_70b_galaxy) |
| tt-metal Commit | `de59f8a` |
| vLLM Commit | `c127c17` |
| Docker Image | `ghcr.io/tenstorrent/tt-inference-server/vllm-tt-metal-src-release-ubuntu-22.04-amd64:0.21.0-de59f8a-c127c17` |
