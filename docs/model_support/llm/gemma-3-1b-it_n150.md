...
docker run \
  ...
  --volume volume_id_gemma-3-1b-it:/home/container_app_user/cache_root \
  ghcr.io/tenstorrent/tt-inference-server/vllm-tt-metal-src-release-ubuntu-22.04-amd64:0.11.0-c254ee3-c4f2327 \
  --model gemma-3-1b-it \
  --tt-device n150
```
...
| vLLM Commit | `c4f2327` |
| Docker Image | `ghcr.io/tenstorrent/tt-inference-server/vllm-tt-metal-src-release-ubuntu-22.04-amd64:0.11.0-c254ee3-c4f2327` |
