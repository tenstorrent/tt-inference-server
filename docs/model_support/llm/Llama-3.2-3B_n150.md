...
docker run \
  ...
  ghcr.io/tenstorrent/tt-inference-server/vllm-tt-metal-src-release-ubuntu-22.04-amd64:0.10.0-20edc39-03cb300 \
  --model Llama-3.2-3B \
  --tt-device n150
```
...
| vLLM Commit | `03cb300` |
| Docker Image | `ghcr.io/tenstorrent/tt-inference-server/vllm-tt-metal-src-release-ubuntu-22.04-amd64:0.11.0-20edc39-03cb300` |
