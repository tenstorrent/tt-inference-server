# Llama-3.1-8B Tenstorrent Support on N300
...
## Quickstart - Deploy Llama-3.1-8B Inference Server on n300
...
```bash
python3 run.py --model meta-llama/Llama-3.1-8B --device n300 --workflow server --docker-server
```
