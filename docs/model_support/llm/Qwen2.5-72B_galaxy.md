...
```bash
python3 run.py --model Qwen/Qwen2.5-72B-Instruct --device galaxy --workflow server --docker-server
```
...
| Parameter | Value |
|-----------|-------|
| Weights | [Qwen/Qwen2.5-72B-Instruct](https://huggingface.co/Qwen/Qwen2.5-72B-Instruct) |
