# Qwen2.5-Coder-32B-Instruct Tenstorrent Support on WH Galaxy
...
- [WH LoudBox/QuietBox](Qwen2.5-Coder-32B-Instruct_t3k.md)

## Quickstart - Deploy Qwen2.5-Coder-32B-Instruct Inference Server on WH Galaxy
...
docker run \
  ...
  ghcr.io/tenstorrent/tt-inference-server/vllm-tt-metal-src-release-ubuntu-22.04-amd64:0.11.0-17a5973-aa4ae1e \
...
| vLLM Commit | `aa4ae1e` |
| Docker Image | `ghcr.io/tenstorrent/tt-inference-server/vllm-tt-metal-src-release-ubuntu-22.04-amd64:0.11.0-17a5973-aa4ae1e` |
