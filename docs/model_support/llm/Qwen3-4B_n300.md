# Qwen3-4B Tenstorrent Support on N300
...
`Qwen3-4B` is also supported on hardware:

- [N150](Qwen3-4B_n150.md)

## Quickstart - Deploy Qwen3-4B Inference Server on n300
...
```bash
python3 run.py --model Qwen/Qwen3-4B --device n300 --workflow server --docker-server
```
