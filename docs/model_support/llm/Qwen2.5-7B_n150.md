...
docker run \
  ...
  ghcr.io/tenstorrent/tt-inference-server/vllm-tt-metal-src-release-ubuntu-22.04-amd64:0.10.0-5b5db8a-e771fff \
  --model Qwen2.5-7B \
  --tt-device n300
```
...
| vLLM Commit | `e771fff` |
| Docker Image | `ghcr.io/tenstorrent/tt-inference-server/vllm-tt-metal-src-release-ubuntu-22.04-amd64:0.11.0-5b5db8a-e771fff` |
