# Llama-3.3-70B-Instruct Tenstorrent Support on BH Galaxy
...
## Quickstart - Deploy Llama-3.3-70B-Instruct Inference Server on BH Galaxy
...
```bash
python3 run.py --model Llama-3.3-70B-Instruct --device blackhole_galaxy --workflow server --docker-server
```
