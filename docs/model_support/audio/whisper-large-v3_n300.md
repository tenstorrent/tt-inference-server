# whisper-large-v3 Tenstorrent Support on N300
...
## Quickstart - Deploy whisper-large-v3 Inference Server on n300
...
```bash
python3 run.py --model openai/whisper-large-v3 --device n300 --workflow server --docker-server
```
