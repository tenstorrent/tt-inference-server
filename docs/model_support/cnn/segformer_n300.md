# segformer Tenstorrent Support on N300
...
`segformer` is also supported on hardware:

- [N150](segformer_n150.md)

## Quickstart - Deploy segformer Inference Server on n300
