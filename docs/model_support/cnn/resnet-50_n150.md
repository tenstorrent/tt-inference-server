# resnet-50 Tenstorrent Support on n150

resnet-50 is also supported on:

- [n300](resnet-50_n300.md)
...
## Quickstart - Deploy resnet-50 Inference Server on n150
...
```bash
python3 run.py --model resnet-50 --device n150 --workflow server --docker-server
```
