...
import ttnn
from tt_metal_impl.tt.utility_functions import tt2torch_tensor, torch2tt_tensor
from loguru import logger
from pathlib import Path
from tt_metal_impl.reference.llama.llama.generation import (
    load_chunked_checkpoints,
    load_sharded_checkpoints,
)
# import pytest
from tt_metal_impl.tt.model_config import get_model_config
