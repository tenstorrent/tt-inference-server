...
DISPLAY_NAMES: Dict[str, str] = {
    ...
    "std_e2el_ms": "E2EL Std (ms)",
    "p50_e2el_ms": "P50 E2EL (ms)",
    ...
    "tps_output_throughput": "Tput Output Wall-Clock (TPS)",
...
EXPLANATIONS: Dict[str, str] = {
    ...
    "tps_decode_throughput": "Decode throughput across all users: per-user decode rate (1000/TPOT) x concurrency (TPS). This is what the tput target grades.",
    "tps_output_throughput": "Total output tokens over the whole benchmark window, so prefill and queueing time are charged to it (TPS). Reported only; not graded.",
