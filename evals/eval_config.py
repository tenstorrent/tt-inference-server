    ...
    EvalConfig(
        ...
        tasks=[
            ...
            EvalTask(
                ...
                num_fewshot=4,
                score=EvalTaskScore(
                    published_score=29.4,
                    published_score_ref="https://huggingface.co/tiiuae/Falcon3-7B-Instruct",
                    gpu_reference_score=40.63,
                    gpu_reference_score_ref="https://github.com/tenstorrent/tt-inference-server/issues/4090",
                    score_func=score_task_single_key,
                    score_func_kwargs={
            ...
            EvalTask(
                ...
                num_fewshot=0,
                score=EvalTaskScore(
                    published_score=31.9,
                    published_score_ref="https://huggingface.co/tiiuae/Falcon3-7B-Instruct",
                    gpu_reference_score=27.83,
                    gpu_reference_score_ref="https://github.com/tenstorrent/tt-inference-server/issues/4090",
                    score_func=score_task_single_key,
                    score_func_kwargs={
                        "result_keys": [
            ...
            EvalTask(
                ...
                num_fewshot=5,
                score=EvalTaskScore(
                    published_score=40.7,
                    published_score_ref="https://huggingface.co/tiiuae/Falcon3-7B-Instruct",
                    gpu_reference_score=54.28,
                    gpu_reference_score_ref="https://github.com/tenstorrent/tt-inference-server/issues/4090",
                    score_func=score_task_single_key,
                    score_func_kwargs={
                        "result_keys": [
