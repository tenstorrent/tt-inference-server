...
_eval_config_list = [
    EvalConfig(
        # GPT-OSS (OpenAI). Minimal eval suite to enable `--workflow evals` for smoke testing.
        #
        # If you want broader coverage, add more EvalTask entries here (see docs/add_support_for_new_model.md).
