...
def load_torch_model(weights_path: str = None):
    ...
    sys.path.insert(0, "models/demos/yunet/YUNet")
    from models.demos.yunet.YUNet.nets import nn as YUNet_nn
...
def get_default_weights_path():
    ...
    return "models/demos/yunet/YUNet/weights/best.pt"
...
def setup_yunet_reference():
    ...
    """
    yunet_dir = "models/demos/yunet/YUNet"
