...
base builds ReportContext, gets extras from strategy hooks, calls generate_benchmark_report.
...
def generate_benchmark_report(
    ...
    benchmarks = (
        ...
        else aggregate_metrics_from_status_list(status_list)
    )
    if extra_benchmarks:
...
def generate_eval_report(
    ...
    This function adds model, device, timestamp, task_type and writes to eval path.
