...
class CNNService(BaseModel):
    ...
    async def processImage(self, image_search_request: ImageSearchRequest) -> str:
        # set task id
        task_id = str(uuid4())
        image_search_request._task_id = task_id
        self.scheduler.process_request(image_search_request)
