...
def test_ladder_levels_above_the_allowed_max_are_dropped():
    from reference_config.benchmarking.benchmark_config import _expand_text_sweep_params

    params = _expand_text_sweep_params(
        isl=131072,
        osl=128,
        max_context=262144,
        max_tokens_all_users=262144,  # budget fits one request at a time
        model_max_concurrency=64,
