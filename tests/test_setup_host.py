...
class TestDeriveCustomWeightsSpec:
    ...
    def test_quetzal_package_identity_cannot_be_relabelled(self, tiny_model_spec):
        quetzal = replace(
            tiny_model_spec,
            impl=ImplSpec(
                impl_id="quetzal",
        ...
        with pytest.raises(ValueError, match="does not support --custom-weights"):
            derive_custom_weights_spec(quetzal, CUSTOM_LABEL_HF)
