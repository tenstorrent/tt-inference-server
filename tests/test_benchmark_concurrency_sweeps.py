...
def test_expand_concurrency_sweeps_text_includes_powers_of_two_and_allowed_max():
    # allowed_max by token budget: 4096 // (128+128) = 16, and model_max=32 => allowed_max=16
    params = [
        BenchmarkTaskParams(
            isl=128,
            osl=128,
...
def test_expand_concurrency_sweeps_text_includes_non_power_of_two_allowed_max():
    # allowed_max by token budget: 5000 // 256 = 19, and model_max=32 => allowed_max=19
    params = [
        BenchmarkTaskParams(
            isl=128,
            osl=128,
...
def test_expand_concurrency_sweeps_text_with_increased_max_tokens_all_users():
    # allowed_max by token budget: 8192 // 256 = 32, not max_context=5000 // 256 = 19
    params = [
        BenchmarkTaskParams(
            isl=128,
            osl=128,
...
def test_expand_concurrency_sweeps_image_accounts_for_vision_tokens():
    ...
    # allowed_max by token budget: 4096 // 512 = 8, model_max=32 => allowed_max=8
    params = [
        BenchmarkTaskParams(
            isl=128,
            osl=128,
