...
python3 run.py --model Qwen2.5-72B-Instruct --device galaxy --workflow release --docker-server --dev-mode
python3 run.py --model Llama-3.1-8B-Instruct --device galaxy --workflow release --docker-server --dev-mode
python3 run.py --model Qwen3-32B --device galaxy --workflow release --docker-server --dev-mode
python3 run.py --model Qwen3-8B --device galaxy --workflow release --docker-server --dev-mode
