...
"""Parser for the InferenceMax ``benchmark_serving.py`` flat JSON shape.

(InferenceMax was previously referred to as InferenceX; the on-disk
``kind`` stays ``inferencex`` for back-compat with existing reports.)
"""
