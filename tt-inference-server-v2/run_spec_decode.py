...
"""Thin launcher for the v2 speculative-decoding benchmark.
...
logger = logging.getLogger("tt_v2_spec_decode_launcher")
...
def main() -> int:
    ...
    logger.info("Launching run.py inside V2_SPEC_DECODE venv: %s", venv_python)
    sys.stdout.flush()
    sys.stderr.flush()
