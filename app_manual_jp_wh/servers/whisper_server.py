...
Usage (inside container):
  TT_MESH_GRAPH_DESC_PATH=/home/container_app_user/tt-metal/tt_metal/fabric/mesh_graph_descriptors/n150_mesh_graph_descriptor.textproto \
    TT_VISIBLE_DEVICES='2' MESH_DEVICE=N150 \
...
def main():
    ...
    parser.add_argument("--language", type=str, default="en", help="Transcription language (en, ja, etc.)")
